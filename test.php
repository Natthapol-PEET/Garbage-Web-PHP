<html lang="en"><head>
  ...
  <body class="goto-here" data-aos-easing="slide" data-aos-duration="800" data-aos-delay="0">
    ...
    <!-- <section id="home-section" class="hero">
	    ...
	    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-3894px, 0px, 0px); transition: all 0s ease 0s; width: 11684px;"><div class="owl-item cloned" style="width: 1947.2px;"><div class="slider-item" style="background-image: url(images/bg_1.jpg);">
	      ...
	      </div></div><div class="owl-item cloned" style="width: 1947.2px;"><div class="slider-item" style="background-image: url(images/bg_2.jpg);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

	            <div class="col-sm-12 ftco-animate text-center fadeInUp ftco-animated">
	      ...
	      </div></div><div class="owl-item active" style="width: 1947.2px;"><div class="slider-item" style="background-image: url(images/bg_1.jpg);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	      ...
	      </div></div><div class="owl-item" style="width: 1947.2px;"><div class="slider-item" style="background-image: url(images/bg_2.jpg);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	      ...
	      </div></div><div class="owl-item cloned" style="width: 1947.2px;"><div class="slider-item" style="background-image: url(images/bg_1.jpg);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
    	...
    	<div class="container">
          ...
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate fadeInUp ftco-animated">
            ...
            <div id="timer" class="d-flex mt-5">
						  <div class="time" id="days">-41<span>Days</span></div>
						  <div class="time pl-3" id="hours">01<span>Hours</span></div>
						  <div class="time pl-3" id="minutes">19<span>Minutes</span></div>
						  <div class="time pl-3" id="seconds">48<span>Seconds</span></div>
						</div>
          </div>
        </div>   		
    	</div>
      ...
      <div class="container">
        ...
        <div class="row ftco-animate fadeInUp ftco-animated">
          <div class="col-md-12">
            ...
            <div class="owl-stage-outer"><div class="owl-stage" style="transition: all 0.25s ease 0s; width: 4180px; transform: translate3d(-760px, 0px, 0px);"><div class="owl-item cloned" style="width: 350px; margin-right: 30px;"><div class="item">
              ...
              </div></div><div class="owl-item cloned active" style="width: 350px; margin-right: 30px;"><div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(images/person_1.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
              ...
              </div></div><div class="owl-item active center" style="width: 350px; margin-right: 30px;"><div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(images/person_1.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright ©<script>document.write(new Date().getFullYear());</script>2020 All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
